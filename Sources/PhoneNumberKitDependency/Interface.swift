...
public struct PhoneNumberKitClient {
	public init(parseSingle: @escaping (ParseSingleNumberRequest) throws -> PhoneNumber, parseMultiple: @escaping (ParseMultipleNumbersRequest) -> [PhoneNumber]) {
...
extension PhoneNumberKitClient: TestDependencyKey {
	public static var testValue: PhoneNumberKitClient = .init(parseSingle: unimplemented("parseSingle"), parseMultiple: unimplemented("parseMultiple"))
}
